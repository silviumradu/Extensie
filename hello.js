...
var postTextByClass = document.getElementsByClassName("qzhwtbm6 knvmm38d");
console.log(postTextByClass[2].innerText);
...
console.log(numberReact[1].innerText);
console.log(numberReact[2].innerText);
